    ...
    render() {
        return (
            <div className="addMovie">
                ...
                <input type="text" onChange={e => this.setState({date: e.target.value})}  value={this.state.date} />
                <span>MOVIE URL</span>
                ...
                <span>OVERVIEW</span>
                <input type="text" onChange={e => this.setState({overview: e.target.value})}  value={this.state.overview} />
                <span>RUNTIME</span>
                <input type="text" onChange={e => this.setState({runtime: e.target.value})}  value={this.state.runtime} />
